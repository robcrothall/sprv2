...
<a href="../ctl/roles_read.php" class="w3-button w3-green">Edit roles</a>&nbsp;
<?php
//	echo '<a href="../ctl/people_read.php?id=' . $_SESSION["selected_people_id"] . '" class="w3-button w3-green">Return</a>&nbsp;';
?>
<div class="row">
		...
		<?php 
         ...
         $cmd   = $cmd1 . $cmd2 . $cmd3;
			...
			if (count($users) > 0) {
               ...
               echo "<td>";
           		if ($u['id'] > 0) {
						echo '<a class="w3-button w3-green" href="../ctl/roles_edit.php?id=' . $u['id'] . '">Edit</a>';
               }
               echo "</td>";
               echo "</tr>\n\r";
				}
