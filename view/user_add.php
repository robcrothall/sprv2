...
<tr>
    <td colspan=2>
        ...
        <a class="w3-button w3-green" href="../view/user_list.php">
    ...
    if (sizeof($errorList) == 0) {
        ...
        echo '</ul>';    
        echo '<a class="w3-button w3-green" href="../view/user_add.php">';
        echo 'Try again</a>';
    }
    ...
    echo '<a class="w3-button w3-green" href="../view/user_list.php">';
