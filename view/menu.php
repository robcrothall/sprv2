...
if (check_role("STAFF") | check_role("ADMIN")) {
    ...
    if (check_role("ADMIN")) {
        echo '<hr>';
        echo '<a href="../page/dashboard02_form.php" ';
        ...
        echo '<a href="../page/ass_memberships_extract.php" ';
        echo 'class="w3-bar-item w3-button">Associate Members Extract</a>';
...
if (check_role("FINANCE") | check_role("ADMIN")) {
    ...
    echo '<div class="w3-dropdown-content w3-bar-block w3-card-4">';
    echo '<a href="../page/ass_memberships_list.php" ';
    echo 'class="w3-bar-item w3-button">';
    echo 'Associate Members</a>';
...
if (check_role("STAFF") | check_role("ADMIN") | check_role("RESIDENT")
    ...
    //if (check_role("CALENDAR")) {
        echo '<a href="../page/calendar_list.php" class="w3-bar-item w3-button">';
        echo 'Calendar</a>';
    //}
    ...
    if (check_role("LIBRARY")) {
        echo '<a href="../page/lib_memberships_list.php" ';
        echo 'class="w3-bar-item w3-button">';
