<h2>List of matching People</h2>
  <div class="container">
   <div class="form-actions">
      <a class="w3-button w3-green" href="../ctl/search.php">Back</a>
   </div>
                ...
                <tbody>
                    ...
                    if (count($rows) > 0) {
                        foreach ($rows as $row) {
                            ...
                            echo 'href="../ctl/people_read.php?id=' . $row['id'];
                            echo '">Read</a>' . '&nbsp;';
                            if ($_SESSION["user_role"] == "STAFF" 
                                or $_SESSION["user_role"] == "ADMIN" 
                            ) {
                                echo '<a class="w3-button w3-green" ';
                                echo 'href="../ctl/people_update.php?id=';
                                echo $row['id'] . '">Update</a>' . '&nbsp;';
                                if ($_SESSION["user_role"] == "ADMIN" ) {
                                    echo '<a class="w3-button w3-red" ';
                                    echo 'href="../ctl/people_delete.php?id=';
