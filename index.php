...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
		<section id="content">
			<img src="https://www.sprv.co.za/sprv/assets/img/logo.jpg" alt="Settlers Park logo" />
			<span>
			...
			<p>
			<a href="https://sprv.co.za/sprv/ctl/login.php">Staff and Residents only</a>
<!--			<p>
			<a href="https://sprv.co.za/dolibarr">Settlers Park Administration</a>
-->		</section>
    </body>
</html>