<?php
/**
 * Program librarymembers_form.php
 * 
 * Parse Library Associate Members document and compare to SPRV
 * 
 * PHP version 7.1
 * 
 * @category Template
...
?>
<h2 align="center">Library list of Associate Members</h2>
<h3 align="left">Options selected are:</h3>
<form action="../page/librarymembers.php" method="post">
...
//   $yr          = $_SESSION["yr"];
//   $yr_c        = $_SESSION["yr_c"];
   $doc_file  = "../data/elec_file" . $_SESSION["year_n"];
